      ...
      <div className="section-container py-12 lg:py-16">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            {/* Logo lockup: BRACU logo | divider | MT logo */}
            ...
            <div className="flex items-center gap-3 mt-5">
              <a
                ...
                aria-label="Facebook"
                className="w-9 h-9 flex items-center justify-center rounded-md text-text-faint hover:text-primary hover:bg-primary-highlight transition-colors duration-150"
              >
          ...
          {Object.entries(footerLinks).map(([group, links]) => (
            <div key={group}>
              <h3 className="text-xs font-semibold uppercase tracking-widest text-text-faint mb-4">
                {group}
              </h3>
        ...
        <div className="mt-10 pt-6 border-t border-divider flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <span className="text-xs text-text-faint">A team of</span>
            <ThemeLogo
              lightSrc="/bracu-logo.svg"
              darkSrc="/bracu-logo-dark.svg"
              alt="BRAC University"

          ...
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div>
              <div className="mb-3 flex items-center gap-2.5">
                ...
                <span className="hud-label text-primary">The Lineage</span>
              </div>
        ...
        <Reveal stagger={0.06} className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {rovers.slice(0, 6).map((r) => (
            <Link
              ...
              className="group relative flex flex-col overflow-hidden rounded-card border border-divider bg-surface-raised transition-all duration-300 hover:-translate-y-1 hover:border-primary/40 hover:shadow-[0_18px_40px_-24px_rgba(var(--primary-rgb),0.55)]"
            >

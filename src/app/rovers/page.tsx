            ...
            <Reveal stagger className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {rovers?.map((rover) => (
                ...
                >
                  ...
                  <div className="relative aspect-[16/10] rounded-xl bg-surface-2 overflow-hidden">
                    {rover.heroImage ? (
                      <Image
                    ...
                    {rover.competition && (
                      <div className="absolute left-3 top-3 z-10 inline-flex items-center rounded-md bg-primary px-2.5 py-1 shadow-lg">

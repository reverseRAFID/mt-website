        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-start mb-16 lg:mb-20">
          <Reveal>
            <div className="flex flex-wrap items-center gap-3 mb-6">
              {rover.competition && (
                <span className="inline-flex items-center rounded-none bg-primary px-3 py-1.5">
          ...
          <Reveal y={32} blur={6} className="order-first lg:order-last lg:sticky lg:top-24">
            {rover.gallery && rover.gallery.length > 0 ? (
              ...
              <div className="relative rounded-card border border-divider bg-surface-raised p-2">
                <div className="relative flex aspect-[4/3] items-center justify-center overflow-hidden rounded-none bg-surface-2">
                  <div className="absolute inset-0 tech-grid-sm opacity-50" aria-hidden />
                  <div className="relative text-center p-8">
                    <div className="mx-auto mb-3 flex h-16 w-16 items-center justify-center rounded-none bg-primary/10">
          ...
          <div className="mb-16 lg:mb-20">
            ...
            <Reveal stagger className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {specs.map(([key, value]) => (
                <div
                  key={key}
                  className="relative rounded-none border border-divider bg-surface p-4 transition-colors hover:border-primary/40"
                >
